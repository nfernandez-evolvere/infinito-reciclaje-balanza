...
<div class="sm:hidden space-y-2">
    ...
    <x-ui.card variant="elevated" class="p-3">
        ...
        <x-ui.card.content class="flex flex-wrap gap-1 pt-1">
...
@if($tipos->hasPages())
    <div class="flex items-center justify-between px-1 pt-2 text-sm text-muted-foreground">
        <span class="flex-1">Página {{ $tipos->currentPage() }} de {{ $tipos->lastPage() }} · {{ number_format($tipos->total(), 0, ',', '.') }} tipos de servicio</span>
