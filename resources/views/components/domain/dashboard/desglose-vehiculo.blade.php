...
<x-ui.card variant="elevated">
    <x-ui.card.header>
        ...
        <x-ui.card.description>Distribución de flota del día</x-ui.card.description>
    </x-ui.card.header>
        ...
        @else
            <x-ui.table variant="flat">
                ...
                <x-ui.table.body>
                    ...
                    <x-ui.table.row>
                        <x-ui.table.cell class="font-medium" data-label="Tipo">{{ $fila['nombre'] }}</x-ui.table.cell>
