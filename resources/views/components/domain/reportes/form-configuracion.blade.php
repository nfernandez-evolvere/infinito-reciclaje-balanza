...
<form method="POST" action="{{ route('admin.reportes.configuracion.update') }}">
    ...
    <div class="flex flex-col gap-6">
        ...
        <x-ui.card>
            <x-ui.card.header>
                <x-ui.card.title>Secciones del informe</x-ui.card.title>
                <x-ui.card.description>Elegí qué partes incluye el informe mensual. Los reportes usan esta selección salvo que un programado la personalice.</x-ui.card.description>
            </x-ui.card.header>
            <x-ui.card.content>
