...
{{--
    Fila de acción del tab Vehículos: trigger de filtros (solo <md, abre el sheet).
    El botón de alta vive en el header de la página (comparte fila con el título).
    En md+ el trigger se oculta porque los filtros viven en el panel inline
    (<x-domain.vehiculos.filtros>) y la fila entera desaparece.
--}}
