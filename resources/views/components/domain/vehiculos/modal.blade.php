...
<div x-data="{
    get mobileOpen() { return modalOpen && window.innerWidth < 640 },
    set mobileOpen(v) { if (!v) modalOpen = false },
    get open() { return modalOpen && window.innerWidth >= 640 },
    set open(v) { if (!v) modalOpen = false }
}">

    {{-- Mobile: bottom sheet --}}
    <x-ui.sheet side="bottom" controlled-by="mobileOpen">
        <form
            method="POST"
        ...
        >
            ...
            <x-ui.sheet.content>
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        >
                            <x-ui.label for="m-patente">Patente</x-ui.label>
                            <x-ui.input
                                id="m-patente"
                                name="patente"
                    ...
                    >
                        <x-ui.label for="m-titular">Titular</x-ui.label>
                        <x-ui.input
                            id="m-titular"
                            name="titular"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        >
                            <x-ui.label for="m-tara_kg">Tara (kg)</x-ui.label>
                            <x-ui.input
                                id="m-tara_kg"
                                name="tara_kg"
                                type="number"
                        ...
                        >
                            <x-ui.label for="m-capacidad_kg">Capacidad (kg) <span class="text-muted-foreground font-normal">— opcional</span></x-ui.label>
                            <x-ui.input
                                id="m-capacidad_kg"
                                name="capacidad_kg"
                                type="number"
                    ...
                    >
                        <x-ui.label for="m-observaciones">Observaciones <span class="text-muted-foreground font-normal">— opcional</span></x-ui.label>
                        <x-ui.textarea
                            id="m-observaciones"
                            name="observaciones"
            ...
            <x-ui.sheet.footer>
                <x-ui.button type="button" variant="ghost" @click="modalOpen = false">
