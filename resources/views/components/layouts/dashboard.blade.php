...
>
    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden p-2 space-y-0.5">
        ...
        $groups = [
            'Principal' => [
                ['icon' => 'home',        'label' => 'Overview',   'href' => '/dashboard',     'active' => request()->is('dashboard')],
                ['icon' => 'list',        'label' => 'Pedidos',    'href' => '/pedidos',        'active' => request()->is('pedidos'),    'badge' => '3'],
                ['icon' => 'package',     'label' => 'Productos',  'href' => '/productos',      'active' => request()->is('productos')],
                ['icon' => 'users',       'label' => 'Clientes',   'href' => '/clientes',       'active' => request()->is('clientes')],
            ],
            'Reportes' => [
                ['icon' => 'activity',    'label' => 'Analytics',  'href' => '/charts',         'active' => request()->is('charts')],
                ['icon' => 'dollar-sign', 'label' => 'Ingresos',   'href' => '/ingresos',       'active' => request()->is('ingresos')],
            ],
            'Sistema' => [
                ['icon' => 'settings',    'label' => 'Config.',    'href' => '/configuracion',  'active' => request()->is('configuracion')],
                ['icon' => 'users-2',     'label' => 'Equipo',     'href' => '/equipo',         'active' => request()->is('equipo')],
            ],
        ];
