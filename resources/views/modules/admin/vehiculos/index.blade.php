...
<div x-data="vehiculos({{ Js::from($initial) }})" class="flex flex-col gap-6">
    ...
    <div class="flex items-start justify-between gap-4">
        <div>
            ...
            <x-ui.typography as="muted" class="mt-1">Padrón de vehículos habilitados para registrar pesajes. La tara de cada vehículo se copia automáticamente al crear un pesaje.</x-ui.typography>
        </div>
