...
6. **Vehículos / Orígenes / Tipos de servicio / Tipos de vehículo / Usuarios** — five ABMs
7. **Reportes** — filterable preview with PDF / Excel export

Admin navigation is grouped as an **accordion** sidebar: *Operación* · *Transporte* · *Orígenes* · *Servicios* · *Sistema* · *Análisis*.
...
| `data.jsx` | Hardcoded master data: vehicles, vehicle types + ranges, services, orígenes, users, sample weighings + change log. |
...
| `AbmVehiculos.jsx` · `AbmOrigenes.jsx` · `AbmServicios.jsx` · `AbmTipos.jsx` · `AbmUsuarios.jsx` | The five ABMs. |
